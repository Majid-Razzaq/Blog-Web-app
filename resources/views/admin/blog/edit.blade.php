...
@section('content')
    ...
    <section class="content  h-100">
        <div class="container-fluid  h-100">
            ...
            <div class="row">
                <div class="col-md-12">
                    <form method="post" name="editBlog" id="editBlog">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        @if(!empty($blog->image))
                                        <img class="image-thumbnail my-4" src="{{ asset('uploads/temp/blogs/thumb/small/'.$blog->image) }}" width="300" alt="">
                                        @endif
...
$("#editBlog").submit(function(event) {
    ...
    $.ajax({
    url: '{{ route("blog.edit.update",$blog->id) }}',
    type: 'POST',
    dataType: 'json',
